...
Lemma F_not_decrease: forall s s' acts
    ...
    -- inversion H3; subst; simpl in *.
      ...
      --- inversion H5; subst; simpl in *.
        ...
        + pose proof Hreach as HreachTmp.
          ...
          unfold inv_front_inc_at_d31 in Hreach.
          ...
          rewrite get_f'_any_rear_push in IHvalid_execution_fragment; auto.
          rewrite get_f'_any_rear_push in IHvalid_execution_fragment; auto.
          simpl in *.
          rewrite Hlist.
        ...
        (* READ *)
        + rewrite get_f'_any_rear_read in IHvalid_execution_fragment; auto.
    (* array *)
    -- inversion H3; subst; simpl in *.
      inversion H4; subst; simpl in *.
      (* CAS *)
      --- destruct ((entry_eqb (Vector.nth vec (Fin.of_nat_lt Hlt))
        ...
        + pose proof Hreach as HreachTmp.
          ...
          ++ apply binds_reconstruct in Hb.
            ...
            repeat rewrite get_f'_dist in IHvalid_execution_fragment; auto.
            simpl in *.
            rewrite get_f'_any_ary in IHvalid_execution_fragment; auto.
            rewrite get_f'_any_ary in IHvalid_execution_fragment; auto.
          ...
          ++ apply binds_reconstruct in Hb.
            ...
            lia.
        (* fail *)
        + rewrite get_f'_any_ary_cas_false in IHvalid_execution_fragment; auto.
      (* READ *)
      --- rewrite get_f'_any_ary_read in IHvalid_execution_fragment; auto.
  - assert (Htmp : composed_lts.reachable (composed_array_queue L) st'').
    eapply reachable_valid_execution; eauto;
  ...
  - assert (Htmp : composed_lts.reachable (composed_array_queue L) st'').
    ...
    inversion H3; subst; simpl in *.
          ...
          all : apply binds_reconstruct in Hbinds0;
            ...
            try (inversion H8; subst; simpl in *);
            try (inversion H7; subst; simpl in *);
            try (rewrite get_f'_any_rear_remove in IHvalid_execution_fragment; auto);
            try (rewrite get_f'_any_rear_remove in IHvalid_execution_fragment; auto);
            try (rewrite get_f'_any_ary_remove in IHvalid_execution_fragment; auto);
            try (rewrite get_f'_any_ary_remove in IHvalid_execution_fragment; auto);
...
Lemma inv_F_increase_step_L1: forall (s s' : composed_lts.state (composed_array_queue L)) acts
  (Hreach : composed_lts.reachable (composed_array_queue L) s),
    ...
    -- inversion H4; subst; simpl in *.
      ...
      --- inversion H6; subst; simpl in *.
        ...
        + pose proof Hreach as HreachTmp.
          ...
          rewrite Nat.eqb_refl in IHvalid_execution_fragment.
          rewrite get_f'_any_front_push in IHvalid_execution_fragment; auto.
          rewrite get_f'_any_front_push in IHvalid_execution_fragment; auto.
          simpl in *.
      ...
      --- destruct ((entry_eqb (Vector.nth vec (Fin.of_nat_lt Hlt)) old)).
        ...
        + pose proof Hreach as HreachTmp.
          ...
          ++ pose proof Hb as HbindsTmp.
            ...
            rewrite Hnotin_res.
            repeat rewrite Nat.add_succ_r; auto.
            eapply F_not_decrease in Htmp; eauto.
            unfold F, R in *; simpl in *.
            unfold get_front, get_rear, get_ary, get_pc in *; simpl in *.
            ...
            rewrite get_f'_any_ary in Htmp; auto.
            rewrite get_f'_any_ary in Htmp; auto.
...
Lemma inv_F_increase_step_L1': forall (s s' : composed_lts.state (composed_array_queue L)) acts n
  (Hreach : composed_lts.reachable (composed_array_queue L) s),
