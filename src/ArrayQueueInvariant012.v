...
Lemma inv_front_read_at_d2_d11_e14: forall k (s : composed_lts.state (composed_array_queue L)),
  reachable_len' (composed_array_queue L) s k ->
  (forall pid,
    binds pid CntRead (get_front s).(Counter.requests) ->
      binds pid ADeq2 (get_pc s) \/
      binds pid ADeq11 (get_pc s) \/
      binds pid AEnq14 (get_pc s)).
Proof.
  induction k; intros.
  ...
  - apply reachable_len_reconstruct in H.
    ...
    -- inversion H3; subst; clear H3.
      ...
      --- subst.
        ...
        inversion H1; subst; simpl in *.
        inversion H2; subst; simpl in *.
        unfold get_front in *; simpl in *; auto.
        inversion H; subst; simpl in *.
        inversion H4; subst; simpl in *; auto.
        inversion H5; subst; simpl in *; auto.
        inversion H6; subst; simpl in *; auto.
...
Lemma inv_front_read_at_d2_d11_e14_invariant :
...
Proof.
  ...
  intros.
  eapply inv_front_read_at_d2_d11_e14; eauto.
Qed.

Definition after_e15 v :=
  v = AEnq26 \/
  v = AEnq27 \/
  v = AEnq28.

Lemma after_e15_Enq26:
  after_e15 (AEnq26).
Proof.
  intros.
  unfold after_e15.
...
Lemma inv_rear_e27_before: forall k (s : composed_lts.state (composed_array_queue L)),
  reachable_len' (composed_array_queue L) s k ->
  (forall pid v (Hv : after_e15 v),
    ...
    exists s1 s2 it acts,
      ...
      binds pid AEnq26 (get_pc s2) /\
      (get_impl s2).(rear) pid = (get_impl s).(rear) pid /\
  ...
  - apply reachable_len_reconstruct in H.
    ...
    -- inversion H3; subst; simpl in *; clear H3.
      ...
      --- subst.
        ...
        subst;
        unfold after_e15 in Hv; intuition; discriminate.
      --- eapply IHk with (pid:=pid) in Hreach; eauto.
    ...
    -- inversion H3; subst; simpl in *; clear H3.
      ...
      --- subst.
        ...
        inversion H0; subst;
        unfold after_e15 in Hv; intuition; try discriminate.
        eapply IHk in Hreach; simpl; eauto; solve_after_e15.
        destruct Hreach as [s1 [s2 [it [acts [Hvalid [Hstep [Hb Heq]]]]]]].
        exists s1, s2, it.
        eexists.
        intuition.
...
Lemma inv_rear_e27_before_invariant: 
  composed_lts.invariant (composed_array_queue L)
...
Proof.
  apply reachable_len'_to_invariant.
  intros.
  eapply inv_rear_e27_before; eauto.
Qed.

Lemma inv_rear_e14_ret_reply: forall k (s : composed_lts.state (composed_array_queue L)),
  reachable_len' (composed_array_queue L) s k ->
  (forall pid ret (Hb :
    ...
    exists s1 s2 acts,
      ...
      composed_lts.step_L1
        ...
        s2 /\
        ret = (get_front s2).(Counter.value)
      ).
Proof.
  induction k; intros.
  - unfold reachable_len' in H0.
...
Lemma inv_rear_e15_ret: forall k (s : composed_lts.state (composed_array_queue L)),
  reachable_len' (composed_array_queue L) s k ->
  (forall pid ret,
    binds pid (AEnq15 ret) (get_pc s) ->
    exists s1 s2 acts,
      composed_lts.valid_execution_fragment (composed_array_queue L) s2 s acts /\
      composed_lts.step_L1
        (composed_array_queue L)
  ...
  - apply reachable_len_reconstruct in H.
    ...
    -- inversion H3; subst; simpl in *; clear H3.
      ...
      --- subst.
        ...
        inversion H0; subst;
        try discriminate.
        apply inv_rear_e14_ret_reply with (pid:=pid0) (ret:=ret) in Hreach.
        destruct Hreach as [s1 [s2 [acts [Hvalid [Hstep Heq]]]]].
        exists s1, s2.
        eexists. intuition.
        eapply composed_lts.valid_execution_fragment_join' with (a:=acts).
...
Lemma inv_rear_e15_ret_invariant: 
  composed_lts.invariant (composed_array_queue L)
  (fun (s : composed_lts.state (composed_array_queue L)) =>
  (forall pid ret,
    binds pid (AEnq15 ret) (get_pc s) ->
